...
_Governed API surface contract mapping routes, verbs, and audiences to SchemaBindings._
...
URI: [jumo:ApiSurface](https://jumo.dev/schemas/jumo-v1/ApiSurface)
...
```mermaid
 classDiagram
    class ApiSurface
    click ApiSurface href "../ApiSurface/"
      ApiSurface : apiVersion
      ...
      ApiSurface : metadata
        ...
        ApiSurface --> "1" Metadata : metadata
      ...
      ApiSurface : spec
        ...
        ApiSurface --> "1" ApiSurfaceSpec : spec
...
| [spec](spec.md) | 1 <br/> [ApiSurfaceSpec](ApiSurfaceSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:ApiSurface |
| native | jumo:ApiSurface |
...
annotations:
  ...
  jumo.composition:
    ...
    value: ADDITIVE
description: Governed API surface contract mapping routes, verbs, and audiences to
  SchemaBindings.
