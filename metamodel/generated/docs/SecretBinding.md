...
_A Git-declared reference to runtime secret material. Values are deliberately not representable here._
...
URI: [jumo:SecretBinding](https://jumo.dev/schemas/jumo-v1/SecretBinding)
...
```mermaid
 classDiagram
    class SecretBinding
    click SecretBinding href "../SecretBinding/"
      SecretBinding : apiVersion
      ...
      SecretBinding : metadata
        ...
        SecretBinding --> "1" Metadata : metadata
      ...
      SecretBinding : spec
        ...
        SecretBinding --> "1" SecretBindingSpec : spec
...
| [spec](spec.md) | 1 <br/> [SecretBindingSpec](SecretBindingSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:SecretBinding |
| native | jumo:SecretBinding |
...
description: A Git-declared reference to runtime secret material. Values are deliberately
