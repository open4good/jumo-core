...
```mermaid
 classDiagram
    class JourneyVerificationSpec
    click JourneyVerificationSpec href "../JourneyVerificationSpec/"
      JourneyVerificationSpec : apiVersion
      ...
      JourneyVerificationSpec : metadata
        ...
        JourneyVerificationSpec --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      JourneyVerificationSpec : targetType





        JourneyVerificationSpec --> "1" JourneyVerificationTarget : targetType
        click JourneyVerificationTarget href "../JourneyVerificationTarget/"
