...
_User or agent preferences attached to a PersonalSpace._
...
URI: [jumo:Preferences](https://jumo.dev/schemas/jumo-v1/Preferences)
...
```mermaid
 classDiagram
    class Preferences
    click Preferences href "../Preferences/"
      Preferences : apiVersion
      ...
      Preferences : metadata
        ...
        Preferences --> "1" Metadata : metadata
      ...
      Preferences : spec
        ...
        Preferences --> "1" PreferencesSpec : spec
...
| [spec](spec.md) | 1 <br/> [PreferencesSpec](PreferencesSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:Preferences |
| native | jumo:Preferences |
...
description: User or agent preferences attached to a PersonalSpace.
