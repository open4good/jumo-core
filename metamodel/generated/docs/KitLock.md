...
_Rendered provenance for one admitted Jumo Kit. Records bytes and evidence; does not authorize execution._
...
URI: [jumo:KitLock](https://jumo.dev/schemas/jumo-v1/KitLock)
...
| [spec](spec.md) | 1 <br/> [KitLockSpec](KitLockSpec.md) |  | direct |
...
description: Rendered provenance for one admitted Jumo Kit. Records bytes and evidence;
