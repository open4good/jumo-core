...
_Realm-local, closed binding for one Jumo Kit release. Supplies values but never grants authority._
...
URI: [jumo:KitBinding](https://jumo.dev/schemas/jumo-v1/KitBinding)
...
```mermaid
 classDiagram
    class KitBinding
    click KitBinding href "../KitBinding/"
      KitBinding : apiVersion
      ...
      KitBinding : metadata
        ...
        KitBinding --> "1" Metadata : metadata
      ...
      KitBinding : spec
        ...
        KitBinding --> "1" KitBindingSpec : spec
...
| [spec](spec.md) | 1 <br/> [KitBindingSpec](KitBindingSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:KitBinding |
| native | jumo:KitBinding |
...
description: Realm-local, closed binding for one Jumo Kit release. Supplies values
