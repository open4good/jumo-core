...
_Mandatory personal space declaration for a human or agent principal within a Realm._
...
URI: [jumo:PersonalSpace](https://jumo.dev/schemas/jumo-v1/PersonalSpace)
...
```mermaid
 classDiagram
    class PersonalSpace
    click PersonalSpace href "../PersonalSpace/"
      PersonalSpace : apiVersion

      PersonalSpace : kind

      PersonalSpace : metadata





        PersonalSpace --> "1" Metadata : metadata
      ...
      PersonalSpace : spec
        ...
        PersonalSpace --> "1" PersonalSpaceSpec : spec
...
| [spec](spec.md) | 1 <br/> [PersonalSpaceSpec](PersonalSpaceSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:PersonalSpace |
| native | jumo:PersonalSpace |
...
description: Mandatory personal space declaration for a human or agent principal within
  a Realm.
