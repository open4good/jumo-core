 ...
 */
public record AssistedJourneyStep(String id, String name, String description, String personaNarration, AssistedJourneyStepKind stepKind, ContractReference projectionSpecRef, ContractReference processSpecRef, ContractReference promptTemplateRef, AssistedJourneyDialogueBinding dialogueBinding, ContractReference subAssistedJourneyRef, ContractReference verificationSpecRef, List<Obligation> requiredObligations, List<String> dependsOn, Boolean parallelizable, String image, JourneyPresentation presentationOverride, String descriptionI18nKey, String narrationI18nKey, String nameI18nKey, List<AssistedJourneyRequiredField> requiredFields)  {
