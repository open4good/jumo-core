...
_Durable Git contract declaring an AI CLI tool available for execution._
...
URI: [jumo:CliToolDefinition](https://jumo.dev/schemas/jumo-v1/CliToolDefinition)
...
```mermaid
 classDiagram
    class CliToolDefinition
    click CliToolDefinition href "../CliToolDefinition/"
      CliToolDefinition : apiVersion

      CliToolDefinition : kind

      CliToolDefinition : metadata





        CliToolDefinition --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      CliToolDefinition : spec





        CliToolDefinition --> "1" CliToolDefinitionSpec : spec
...
| [spec](spec.md) | 1 <br/> [CliToolDefinitionSpec](CliToolDefinitionSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:CliToolDefinition |
| native | jumo:CliToolDefinition |
...
annotations:
  ...
  jumo.composition:
    ...
    value: ADDITIVE
description: Durable Git contract declaring an AI CLI tool available for execution.
from_schema: https://jumo.dev/schemas/jumo-v1
attributes:
  apiVersion:
    name: apiVersion
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: CliToolDefinition
    domain_of:
    - Principal
  ...
  kind:
    ...
    range: string
    required: true
    equals_string: CliToolDefinition
  metadata:
    name: metadata
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: CliToolDefinition
