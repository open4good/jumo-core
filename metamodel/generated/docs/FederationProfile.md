...
_A negotiated, namespaced protocol profile. Describes messages only and cannot grant authority._
...
URI: [jumo:FederationProfile](https://jumo.dev/schemas/jumo-v1/FederationProfile)
...
```mermaid
 classDiagram
    class FederationProfile
    click FederationProfile href "../FederationProfile/"
      FederationProfile : apiVersion

      FederationProfile : kind

      FederationProfile : metadata





        FederationProfile --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      FederationProfile : spec





        FederationProfile --> "1" FederationProfileSpec : spec
...
| [spec](spec.md) | 1 <br/> [FederationProfileSpec](FederationProfileSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:FederationProfile |
| native | jumo:FederationProfile |
...
description: A negotiated, namespaced protocol profile. Describes messages only and
...
attributes:
  ...
  kind:
    ...
    range: string
    required: true
    equals_string: FederationProfile
  metadata:
    name: metadata
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: FederationProfile
