...
_A reviewed, deployable MCP package. Describes mechanism and semantic affordances; never grants authority._
...
URI: [jumo:McpBundle](https://jumo.dev/schemas/jumo-v1/McpBundle)
...
```mermaid
 classDiagram
    class McpBundle
    click McpBundle href "../McpBundle/"
      McpBundle : apiVersion
      ...
      McpBundle : spec
        ...
        McpBundle --> "1" McpBundleSpec : spec
...
| [spec](spec.md) | 1 <br/> [McpBundleSpec](McpBundleSpec.md) |  | direct |
...
description: A reviewed, deployable MCP package. Describes mechanism and semantic
  affordances; never grants authority.
