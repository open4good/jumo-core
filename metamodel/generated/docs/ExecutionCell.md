...
_A Realm-bound execution cell boundary that manages compute placement, local credential custody, and outbound mTLS execution leases._
...
URI: [jumo:ExecutionCell](https://jumo.dev/schemas/jumo-v1/ExecutionCell)
...
```mermaid
 classDiagram
    class ExecutionCell
    click ExecutionCell href "../ExecutionCell/"
      ExecutionCell : apiVersion

      ExecutionCell : kind

      ExecutionCell : metadata





        ExecutionCell --> "1" Metadata : metadata
      ...
      ExecutionCell : spec
        ...
        ExecutionCell --> "1" ExecutionCellSpec : spec
...
| [spec](spec.md) | 1 <br/> [ExecutionCellSpec](ExecutionCellSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:ExecutionCell |
| native | jumo:ExecutionCell |
...
description: A Realm-bound execution cell boundary that manages compute placement,
  local credential custody, and outbound mTLS execution leases.
