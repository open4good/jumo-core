...
_Root manifest for one portable Jumo Kit repository. Official schemas are supplied by Jumo, never by the kit repository. An active contract kind: the manifest a kit repository itself declares._
...
URI: [jumo:JumoKit](https://jumo.dev/schemas/jumo-v1/JumoKit)
...
| [spec](spec.md) | 1 <br/> [JumoKitSpec](JumoKitSpec.md) |  | direct |
...
description: 'Root manifest for one portable Jumo Kit repository. Official schemas
  are supplied by Jumo, never by the kit repository. An active contract kind: the
  manifest a kit repository itself declares.'
