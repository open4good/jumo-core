...
_A Realm-owned composition of roles and nested teams. Coordinates eligible roles but grants no data access, capability or effect authority. Renamed from OperatorTeam._
...
URI: [jumo:TeamSpec](https://jumo.dev/schemas/jumo-v1/TeamSpec)
...
| [spec](spec.md) | 1 <br/> [TeamSpecBody](TeamSpecBody.md) |  | direct |
...
description: A Realm-owned composition of roles and nested teams. Coordinates eligible
  roles but grants no data access, capability or effect authority. Renamed from OperatorTeam.
