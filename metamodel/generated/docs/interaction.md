...
URI: [jumo:interaction](https://jumo.dev/schemas/jumo-v1/interaction)
...
| Property | Value |
| --- | --- |
| Range | [WorkerInteractionRequirement](WorkerInteractionRequirement.md) |
...
| ---  | ---  |
| self | jumo:interaction |
| native | jumo:interaction |
