...
URI: [jumo:GoldenTaskSet](https://jumo.dev/schemas/jumo-v1/GoldenTaskSet)
...
```mermaid
 classDiagram
    class GoldenTaskSet
    click GoldenTaskSet href "../GoldenTaskSet/"
      GoldenTaskSet : apiVersion

      GoldenTaskSet : kind

      GoldenTaskSet : metadata





        GoldenTaskSet --> "1" Metadata : metadata
      ...
      GoldenTaskSet : spec
        ...
        GoldenTaskSet --> "1" GoldenTaskSetSpec : spec
...
| [spec](spec.md) | 1 <br/> [GoldenTaskSetSpec](GoldenTaskSetSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:GoldenTaskSet |
| native | jumo:GoldenTaskSet |
