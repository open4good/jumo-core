...
_A stable Realm-owned acting role carrying a mission. Its bearer is declared separately by RoleAssignment; neither declaration grants authority. Renamed from Operator._
...
URI: [jumo:RoleDefinition](https://jumo.dev/schemas/jumo-v1/RoleDefinition)
...
```mermaid
 classDiagram
    class RoleDefinition
    click RoleDefinition href "../RoleDefinition/"
      RoleDefinition : apiVersion
      ...
      RoleDefinition : metadata
        ...
        RoleDefinition --> "1" Metadata : metadata
      ...
      RoleDefinition : spec
        ...
        RoleDefinition --> "1" RoleDefinitionSpec : spec
...
| [spec](spec.md) | 1 <br/> [RoleDefinitionSpec](RoleDefinitionSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:RoleDefinition |
| native | jumo:RoleDefinition |
...
description: A stable Realm-owned acting role carrying a mission. Its bearer is declared
  separately by RoleAssignment; neither declaration grants authority. Renamed from
  Operator.
