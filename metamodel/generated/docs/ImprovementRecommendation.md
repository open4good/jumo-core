...
```mermaid
 classDiagram
    class ImprovementRecommendation
    click ImprovementRecommendation href "../ImprovementRecommendation/"
      ImprovementRecommendation : apiVersion

      ImprovementRecommendation : kind

      ImprovementRecommendation : metadata





        ImprovementRecommendation --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      ImprovementRecommendation : spec





        ImprovementRecommendation --> "1" ImprovementRecommendationSpec : spec
