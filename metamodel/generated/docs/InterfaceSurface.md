...
URI: [jumo:InterfaceSurface](https://jumo.dev/schemas/jumo-v1/InterfaceSurface)
...
```mermaid
 classDiagram
    class InterfaceSurface
    click InterfaceSurface href "../InterfaceSurface/"
      InterfaceSurface : apiVersion

      InterfaceSurface : kind

      InterfaceSurface : metadata





        InterfaceSurface --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      InterfaceSurface : spec





        InterfaceSurface --> "1" InterfaceSurfaceSpec : spec
...
| [spec](spec.md) | 1 <br/> [InterfaceSurfaceSpec](InterfaceSurfaceSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:InterfaceSurface |
| native | jumo:InterfaceSurface |
...
attributes:
  ...
  kind:
    ...
    range: string
    required: true
    equals_string: InterfaceSurface
  metadata:
    name: metadata
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: InterfaceSurface
