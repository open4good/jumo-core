...
_Declaration of a multi-turn governed assisted onboarding journey._
...
URI: [jumo:AssistedJourney](https://jumo.dev/schemas/jumo-v1/AssistedJourney)
...
```mermaid
 classDiagram
    class AssistedJourney
    click AssistedJourney href "../AssistedJourney/"
      AssistedJourney : apiVersion

      AssistedJourney : kind

      AssistedJourney : metadata





        AssistedJourney --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      AssistedJourney : spec





        AssistedJourney --> "1" AssistedJourneySpec : spec
...
| [spec](spec.md) | 1 <br/> [AssistedJourneySpec](AssistedJourneySpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:AssistedJourney |
| native | jumo:AssistedJourney |
...
description: Declaration of a multi-turn governed assisted onboarding journey.
from_schema: https://jumo.dev/schemas/jumo-v1
attributes:
  apiVersion:
    name: apiVersion
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: AssistedJourney
    domain_of:
    - Principal
