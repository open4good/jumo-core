...
# Class: RemoteMcpAppraisal

<div data-search-exclude markdown="1">



URI: [jumo:RemoteMcpAppraisal](https://jumo.dev/schemas/jumo-v1/RemoteMcpAppraisal)
...
```mermaid
 classDiagram
    class RemoteMcpAppraisal
    click RemoteMcpAppraisal href "../RemoteMcpAppraisal/"
      RemoteMcpAppraisal : apiVersion

      RemoteMcpAppraisal : kind

      RemoteMcpAppraisal : metadata





        RemoteMcpAppraisal --> "1" Metadata : metadata
        click Metadata href "../Metadata/"



      RemoteMcpAppraisal : spec





        RemoteMcpAppraisal --> "1" RemoteMcpAppraisalSpec : spec
...
| [spec](spec.md) | 1 <br/> [RemoteMcpAppraisalSpec](RemoteMcpAppraisalSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:RemoteMcpAppraisal |
| native | jumo:RemoteMcpAppraisal |
...
attributes:
  ...
  kind:
    ...
    range: string
    required: true
    equals_string: RemoteMcpAppraisal
  metadata:
    name: metadata
    from_schema: https://jumo.dev/schemas/jumo-v1
    owner: RemoteMcpAppraisal
