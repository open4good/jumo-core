...
_A governed body of work declared in a Realm control repository. Git repositories are optional bound resources, not the identity of a Project._
...
URI: [jumo:Project](https://jumo.dev/schemas/jumo-v1/Project)
...
| [spec](spec.md) | 1 <br/> [ProjectSpec](ProjectSpec.md) |  | direct |
...
annotations:
  jumo.composition:
    ...
    value: REALM_ONLY
  openapi.resource:
    tag: openapi.resource
    value: true
  openapi.operations:
    tag: openapi.operations
    value: list,get
...
description: A governed body of work declared in a Realm control repository. Git repositories
  are optional bound resources, not the identity of a Project.
