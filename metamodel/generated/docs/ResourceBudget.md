...
_Per-Episode frugality limits. Assurance may never degrade silently to stay within budget._
...
URI: [jumo:ResourceBudget](https://jumo.dev/schemas/jumo-v1/ResourceBudget)
...
```mermaid
 classDiagram
    class ResourceBudget
    click ResourceBudget href "../ResourceBudget/"
      ResourceBudget : apiVersion

      ResourceBudget : kind

      ResourceBudget : metadata





        ResourceBudget --> "1" Metadata : metadata
      ...
      ResourceBudget : spec
        ...
        ResourceBudget --> "1" ResourceBudgetSpec : spec
...
| [spec](spec.md) | 1 <br/> [ResourceBudgetSpec](ResourceBudgetSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:ResourceBudget |
| native | jumo:ResourceBudget |
...
description: Per-Episode frugality limits. Assurance may never degrade silently to
  stay within budget.
