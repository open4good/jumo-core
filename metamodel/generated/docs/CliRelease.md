...
_Durable Git contract pinning an immutable OCI container release for a CLI tool._
...
URI: [jumo:CliRelease](https://jumo.dev/schemas/jumo-v1/CliRelease)
...
```mermaid
 classDiagram
    class CliRelease
    click CliRelease href "../CliRelease/"
      CliRelease : apiVersion
      ...
      CliRelease : metadata
        ...
        CliRelease --> "1" Metadata : metadata
      ...
      CliRelease : spec
        ...
        CliRelease --> "1" CliReleaseSpec : spec
...
| [spec](spec.md) | 1 <br/> [CliReleaseSpec](CliReleaseSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:CliRelease |
| native | jumo:CliRelease |
...
annotations:
  ...
  jumo.composition:
    ...
    value: ADDITIVE
description: Durable Git contract pinning an immutable OCI container release for a
  CLI tool.
