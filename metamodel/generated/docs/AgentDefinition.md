...
_Reusable, portable agent behavior. Requests capabilities; never grants them. Renamed from AgentArchetype._
...
URI: [jumo:AgentDefinition](https://jumo.dev/schemas/jumo-v1/AgentDefinition)
...
```mermaid
 classDiagram
    class AgentDefinition
    click AgentDefinition href "../AgentDefinition/"
      AgentDefinition : apiVersion
      ...
      AgentDefinition : metadata
        ...
        AgentDefinition --> "1" Metadata : metadata
      ...
      AgentDefinition : spec
        ...
        AgentDefinition --> "1" AgentDefinitionSpec : spec
...
| [spec](spec.md) | 1 <br/> [AgentDefinitionSpec](AgentDefinitionSpec.md) |  | direct |
...
| ---  | ---  |
| self | jumo:AgentDefinition |
| native | jumo:AgentDefinition |
...
description: Reusable, portable agent behavior. Requests capabilities; never grants
  them. Renamed from AgentArchetype.
