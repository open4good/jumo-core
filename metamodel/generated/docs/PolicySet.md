...
_Executable authorization. Only policies allow, deny or impose obligations. Every action named here must resolve against the capability registry._
...
URI: [jumo:PolicySet](https://jumo.dev/schemas/jumo-v1/PolicySet)
...
```mermaid
 classDiagram
    class PolicySet
    click PolicySet href "../PolicySet/"
      PolicySet : apiVersion
      ...
      PolicySet : spec
        ...
        PolicySet --> "1" PolicySetSpec : spec
...
| [spec](spec.md) | 1 <br/> [PolicySetSpec](PolicySetSpec.md) |  | direct |
...
description: Executable authorization. Only policies allow, deny or impose obligations.
  Every action named here must resolve against the capability registry.
